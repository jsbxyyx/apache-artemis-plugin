...
public class MQTT2SessionCallback implements SessionCallback {

   private final MQTT2Session session;
   private final MQTT2Connection connection;

   public MQTT2SessionCallback(MQTT2Session session, MQTT2Connection connection) throws Exception {
   ...
   public int sendMessage(MessageReference ref,
      ...
      try {
         ...
         MQTT2Logger.LOGGER.unableToSendMessage(ref, e);
      }
      return 1;
   }
   ...
   public void disconnect(ServerConsumer consumer, String errorMessage) {
      try {
         ...
         MQTT2Logger.LOGGER.errorDisconnectingConsumer(e);
      }
   }
