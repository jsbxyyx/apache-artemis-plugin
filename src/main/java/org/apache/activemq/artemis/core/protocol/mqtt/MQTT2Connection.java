...
public class MQTT2Connection extends AbstractRemotingConnection {
    ...
    public MQTT2Connection(Connection transportConnection) throws Exception {
    ...
    public String getProtocolName() {
        return MQTT2ProtocolManagerFactory.MQTT_PROTOCOL_NAME + (protocolVersion != null ? protocolVersion : "");
    }
