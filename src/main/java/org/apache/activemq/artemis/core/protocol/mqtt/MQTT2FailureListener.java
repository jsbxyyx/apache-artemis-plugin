 ...
 */
public class MQTT2FailureListener implements FailureListener {

   private MQTT2ConnectionManager connectionManager;

   public MQTT2FailureListener(MQTT2ConnectionManager connectionManager) {
