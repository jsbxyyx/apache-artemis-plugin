...
public class MQTT2RetainMessageManager {

   private MQTT2Session session;

   public MQTT2RetainMessageManager(MQTT2Session session) {
   ...
   void handleRetainedMessage(Message messageParameter, String address, boolean reset, Transaction tx) throws Exception {
      String retainAddress = MQTT2Util.getCoreRetainAddressFromMqttTopic(address, session.getWildcardConfiguration());
